...
\title{
    \vspace{-0.5cm}
    % \LARGE\textbf{Modelling Visual and Programmatic UI Layouts in Swift} \\
    % \LARGE\textbf{Properties of Visual and Programmatic Interface Layouts} \\
    % \LARGE\textbf{Type Safety in Object-Oriented Data Serialisation} \\
    \Large\textbf{TypeScript Object Notation (TSON): JSON with Syntax for Types} \\
    \vspace{0.5cm}
