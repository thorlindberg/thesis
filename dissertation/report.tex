...
\section{SERIALISATION FORMATS} % purpose and formats
\subfile{sections/serialisation}

\section{USABILITY} % human readability
\subfile{sections/usability}

\section{TYPE SAFETY} % validity and type safety
\subfile{sections/typesafety}
