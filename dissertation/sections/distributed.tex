...
The network layer is one of multiple layers typical of networking systems. The OSI model abstracts networking systems into a conceptual framework, describing the functional relationships necessary for communication. \cite{alani2014guide} outlines the layers... \\
