...
\cite{charmaz2006constructing} presents 

\cite{norman2013design} coined the term \textit{User Experience} in his definitive book on design. His philosophy of perception, action and reflection established a conceptual framework through which we can view the design of objects.
