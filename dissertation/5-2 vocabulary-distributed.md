...
In this section I present the terminology used for the architectural and procedural structure of a distributed computing system. This is useful for the development of my proposal because data interchange formats are intermediaries between programming languages and distributed systems, with the data being transformed in different ways at different layers of the system. This influences our understanding of what the data constitutes, and thus it must inform how we design and develop a proposal for the evolution of a format.
...
{"fig":"networkcomms","url":"figures/networkcomms.png","caption":"A distributed system connects processors by a communication network.","width":"70%"}
...
{"fig":"ositcilayers","url":"figures/ositcilayers.png","caption":"Comparison between layers in the OSI model and TCI/IP model, providing a standard communication architecture for distributed processing systems.","width":"70%"}
...
{"fig":"dataflow","url":"figures/endtoendflow.png","caption":"End-to-end data flow.","width":"70%"}

{"fig":"encapsulation","url":"figures/encapsulation.png","caption":"Encapsulation with headers and trailers.","width":"70%"}
