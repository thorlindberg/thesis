...
| Section          | Paragraphs |
| :--------------- | :--------- |
| Context          | <br> ... <br><br> The core of this project is design philosophy in data formats, balancing human-readability (e.g. for troubleshooting) with validity (e.g. type requirements). <br><br> |
